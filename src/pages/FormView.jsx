...
export default function FormView() {
                ...
                if (linkId && (leadName || leadEmail || leadPhone)) {
                    try {
                        ...
                        if (leadResponse.success) {
                            ...
                            showToast(leadResponse.message || "Failed to submit form", "error");
                            return;
                        }
                    } catch (leadError) {
    ...
    return (
        <div className="w-full min-h-screen custom-from-wrapper flex items-center justify-center ">
            {/* Form Preview Card */}
            <div className="  p-3 sm:p-8 py-10 w-full flex flex-col justify-center items-center">
                <div className="glass-card p-3 sm:p-8 py-8">
                    <div className="header">
                        {formData.topHeading?.content == "" ?
                            ""
                            :
                            <div className="badge text-[var(--text-light)] text-start">
                                <span className="icon">
                                    <MaskImage url={`/icons/${formData.topHeading?.icon || "gift"}.svg`} w="1em" h="1em" bg="var(--text-light)" />
                                </span>
                                {formData.topHeading.content || "Exclusive Deals"}
                            </div>
                        }
                    ...
                    {formData.offers.length > 0 &&
                        <div className="benefits">
                            <h4 className="text-[var(--text-light)]">
                                ...
                                {formData.offers.offersHeading || "What You'll Get"}
                            </h4>
