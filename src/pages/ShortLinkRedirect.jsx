        ...
        const handleRedirect = async () => {
            try {
                ...
                if (link.destinationType === 'url' && link.link) {
                    ...
                    // Detect and prevent infinite redirection loops
                    if (targetUrl === window.location.href || targetUrl.includes(window.location.pathname)) {
                        setError("Warning: Infinite redirect loop detected. Please update the link destination.");
                        setLoading(false);
                        return;
                    }
