        ...
        <div className="px-4 mt-6">
            <div className="flex-1 mt-5 w-full max-w-[1400px] mx-auto ">
                ...
                <div className={`grid grid-cols-12 ${tab == "profile" ? "" : "hidden"} gap-6`}>
                        ...
                        <form ref={formRef} className="grid grid-cols-1 mt-8 gap-6" onSubmit={handleUpdateProfile}>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <input type="email"
                                    ...
                                    value={email}
                                    disabled="true"
                                    className="bg-[var(--bg-w)] text-[.7em] opacity-50 text-[var(--text-dark-1)] placeholder:text-[1em] create-input  placeholder:text-[color-mix(in_srgb,var(--text-dark-1)_50%,rgba(255,255,255,0))] rounded-[8px] p-[9px] px-3 flex items-center justify-center "
                    ...
                    {/* <div className=" col-span-12 md:col-span-6 h-max bg-[var(--bg-w)] w-full  rounded-[8px] shadow-[0px_0px_10px_rgba(0,0,0,0.1)] p-6 text-[20px]">
