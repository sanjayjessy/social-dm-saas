                        ...
                        {loading ? (
                            ...
                            <>
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {forms.map((form) => (
                                        <div key={form._id} className={`group bg-[var(--bg-w)] border border-[var(--border)] rounded-[16px] overflow-hidden hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)] transition-all duration-300 flex flex-col ${!form.isActive ? 'opacity-75 grayscale-[0.2]' : ''}`}>
                                            ...
                                            <div className="px-6 pb-6 pt-5 relative flex flex-col h-full">
                                                <div className="flex justify-between items-start mb-4">
                                                    <div>
                                                        ...
                                                        <h3 className="text-[1.25em] font-bold text-[var(--text-dark)] leading-tight mt-1">{capitalizeWords(form.name)}</h3>
                                                    </div>

                                                    {/* Actions Dropdown */}
                                                    <div className="flex items-center gap-2">
                                                        <span className={`text-[0.75em] px-3 py-1 rounded-full font-medium ${form.isActive ? 'bg-[#16c60c15] text-[#16c60c]' : 'bg-[#e8122415] text-[#e81224]'}`}>
                                                        ...
                                                        <div className="relative z-20">
                                                            ...
                                                            {openMenuId === form._id && (
                                                                <div className="absolute right-0 mt-2 w-48 bg-[var(--bg-w)] border border-[var(--border)] rounded-xl shadow-xl z-30 py-2 overflow-hidden">
                                                                    <div onClick={() => navigate(`/create-form?edit=${form._id}`)} className="flex items-center gap-3 px-4 py-2.5 hover:bg-[var(--hover)] cursor-pointer transition-colors text-[var(--text-dark)] text-[0.85em] font-medium">
                                                                        <MaskImage url="/icons/edit.svg" w="1.1em" h="1.1em" bg="var(--primary-color)" />
                                                                        Edit Form
                                                                    </div>
                                                                    <div onClick={() => handleToggleStatus(form._id, form.isActive, "active")} className="flex items-center gap-3 px-4 py-2.5 hover:bg-[var(--hover)] cursor-pointer transition-colors text-[var(--text-dark)] text-[0.85em] font-medium">
                                                                        <MaskImage url="/icons/unread.svg" w="1.1em" h="1.1em" bg={form.isActive ? "#e81224" : "#16c60c"} />
                                                                        {form.isActive ? "Deactivate" : "Activate"}
                                                                    </div>
                                                                    <div className="h-px bg-[var(--border)] my-1"></div>
                                                                    <div onClick={() => handleToggleStatus(form._id, form.isDeleted, "trash")} className="flex items-center gap-3 px-4 py-2.5 hover:bg-red-50 dark:hover:bg-red-900/10 cursor-pointer transition-colors text-[#ff4c51] text-[0.85em] font-medium">
                                                ...
                                                <div className="flex items-center gap-3 mt-auto">
                                                    <button onClick={() => window.open(`/form/${form._id}`, '_blank')} className="flex-1 bg-[var(--primary-color)] text-[var(--text-light)] py-2.5 rounded-[10px] flex justify-center items-center gap-2 text-[0.85em] font-semibold hover:-translate-y-0.5 shadow-md shadow-[color-mix(in_srgb,var(--primary-color)_30%,rgba(0,0,0,0))] transition-all duration-300">
                                                        <MaskImage url="/icons/open.svg" w="1.2em" h="1.2em" bg="currentColor" />
                                                        View Form
                                                    </button>
                                                    <button onClick={() => navigate(`/create-form?edit=${form._id}`)} className="flex-1 bg-[var(--hover)] text-[var(--text-dark)] py-2.5 rounded-[10px] flex justify-center items-center gap-2 text-[0.85em] font-semibold hover:-translate-y-0.5 hover:bg-[var(--border)] transition-all duration-300 border border-[var(--border)]">
                                                        <MaskImage url="/icons/edit.svg" w="1.2em" h="1.2em" bg="currentColor" />
                                                        Edit
                                                    </button>
                                                </div>
                                            </div>
