                        ...
                        {loading ? (
                            ...
                            <>
                                <div className="space-y-4 grid grid-cols-12 gap-4">
                                    {cards.map((card) => (
                                        <div key={card._id} className={`border 2xl:col-span-4 md:col-span-6 col-span-12 border-[var(--border)] m-0 rounded-[8px]  text-[15px] shadow-lg transition-all duration-300 p-3 ${!card.isActive
                                            ? 'opacity-70'
                                            : ''
                                            }`}>
                                            <div className="flex min-w-0">
                                                ...
                                                <div className="flex flex-col px-3 w-full">
                                                    <div className="flex justify-between  w-full">
                                                        ...
                                                        <p className={`text-[var(-text-dark)] h-max text-[.8em] font-semibold p-1 px-3  rounded-[8px] ${card.isActive
                                                            ? "bg-green-100 text-green-700"
                                                            : "bg-red-100 text-red-700"
                                                            }`}>{card.isActive ? "Active" : "Deactive"}</p>
                                                    </div>
                                                        ...
                                                        <div className="flex items-center justify-center  relative z-10">
                                                            ...
                                                            {openMenuId === card._id && (
                                                                <div
                                                                    ...
                                                                    <div
                                                                        onClick={() => navigate(`/create-card?edit=${card._id}`)}
                                                                        title="Edit card"
                                                                        className="text-[var(-text-dark)] hidden  cursor-pointer lg:flex items-center  gap-2  shadow-[0px_4px_10px_rgba(0,0,0,0.1)] border border-[var(--border)] text-[.85em] font-semibold p-2 px-4 bg-[color-mix(in_srgb,var(--hover)_100%,rgba(255,255,255,0))] hover:translate-y-[-2px] duration-400 rounded-[5px] ">
                                                                        <MaskImage url="/icons/edit.svg" w="1.3em" h="1.3em" bg="var(--primary-color)" />
                                                                        Edit
                                                                    </div>
                                                                    <div
                                                                        onClick={() => handleToggleStatus(card._id, card.isActive, "active")}
                                                                        ...
                                                                        <MaskImage url="/icons/unread.svg" w="1.3em" h="1.3em" bg={card.status == "active" ? "#e81224" : "#16c60c"} />
                                                                        {card.status == "active" ? "Deactivate" : "Activate"}
                                                                    </div>
                                                                    <div
                                                                        onClick={() => handleToggleStatus(card._id, card.inTrash, "trash")}
                                                                        title="Delete link"
