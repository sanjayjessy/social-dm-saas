...
router.get("/", protect, async (req, res) => {
    try {
        ...
        const query = { workspaceId: req.user.workspaceId }; // you can add filters later if you want (type, read/unread, etc.)
...
router.put("/read-all", protect, async (req, res) => {
    try {
        ...
        await Notification.updateMany(
            { readBy: { $ne: userId }, workspaceId: req.user.workspaceId },      // only those not read
